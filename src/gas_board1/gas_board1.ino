...
/*ESP-NOW相關設定*/
// 接收方的mac位置
uint8_t broadcastAddress[] = {0x50, 0x0A, 0xC4, 0x59, 0xA5, 0x44};
...
void earthquk_setup(){
  ...
  myAcc.setActivityParameters(ADXL345_DC_MODE, ADXL345_0YZ, 1.80);
...
void scan_weight(){
  ...
  scale.set_scale(-20);
  realweight = scale.get_units(-16)+1300;
  if(realweight<0){realweight=0;}
