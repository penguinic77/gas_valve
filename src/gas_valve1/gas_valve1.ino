...
String gasname="gas1";
uint8_t newMACAddress[] = {0x50, 0x0A, 0xC4, 0x59, 0xA5, 0x44}; //新的MAC位址
...
void vinsenser()
{
  ...
  for(int i=0;i<5;i++){
    ...
    vin = ((ads.readADC_SingleEnded(0)*3.2*3)/1000.0)+4.5;
    vout += vin;
  }
  vout /= 5;
...
void setup() {
  ...
  WiFi.softAP("Gas_valve1",NULL,1,1);
